...
I created a convolutional neural network to classify handwritten digits. It takes in an image of a handwritten number from 0-9 and outputs what it thinks the number is. It is ~99% accurate in identifying the correct number.
<br><br>
